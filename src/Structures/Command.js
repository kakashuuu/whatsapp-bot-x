...
/**
 * @typedef {{category: 'general' | 'moderation' | 'economy' | 'dev' | 'weeb' | 'nsfw' | 'utils' | 'category', description: string, usage: string, aliases?: string[], exp?: number, dm?: boolean, cooldown?: number}} config
 */
