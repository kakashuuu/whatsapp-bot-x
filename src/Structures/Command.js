...
/**
 * @typedef {{category: 'general' | 'moderation' | 'dev' | 'weeb' | 'utils' | 'category', description: string, usage: string, aliases?: string[], exp?: number, dm?: boolean, cooldown?: number}} config
 */
